...
// in news/test/features/news_feature/domain/usecases/get_top_headlines_test.dart.
...
import 'package:news/core/error/failure.dart' as _i5;
...
class MockArticleRepository extends _i1.Mock implements _i3.ArticleRepository {
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, List<_i6.ArticleEntity>>> getTopHeadlines(
          String? channelName) =>
      (super.noSuchMethod(
        Invocation.method(
          #getTopHeadlines,
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, List<_i6.ArticleEntity>>> getCategoryNews(
          String? category) =>
      (super.noSuchMethod(
        Invocation.method(
          #getCategoryNews,
